    ...
    render() {
        return (
            <FormGroup>
                ...
                <Input className="inputDatepickerModule" 
                style={{width: "unset"}} //invalid={this.props.invalid ? true: false} 
                type="date"
                value={this.props.inputValue}
                 className="inputTextModule" name="text" onChange={(e) => this.updateText(e.target.value)}
                 />
