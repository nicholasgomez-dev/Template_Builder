...
import s from './CollapsableWidget.module.scss';
...
class CWidget extends React.Component {
  static propTypes = {
    ...
    <React.Fragment>
      <section
        ...
        >
        {
          title && (
            typeof title === 'string'
              ? <span><h5 className={s.title} onClick={this.handleCollapse}>{title} {this.state.collapseWidget ? <span className={s.floatArrow}><i class="fa fa-angle-up"></i></span> : <span className={s.floatArrow}><i class="fa fa-angle-down "></i></span>}</h5></span>
