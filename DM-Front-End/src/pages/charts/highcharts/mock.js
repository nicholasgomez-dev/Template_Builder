...
export default {
  ...
  pie: {
    ...
    colors: ['#1A86D0', '#21AE8C', '#FDA700', '#FD5F00', '#4d8cb9', '#0a3452', '#43ADF6'],
    series: [{
      minPointSize: 10,
      innerSize: '20%',
      zMin: 0,
  ...
  sunburst: {
    ...
    colors: ['#0a3452', '#21AE8C', '#FDA700', '#FD5F00', '#4d8cb9', '#3c484f', '#17a2b8'],
    series: [{
      type: "sunburst",
      data: sunburstData,
  ...
  wordCloud: {
    ...
    colors: ['#1A86D0', '#21AE8C', '#FDA700', '#FD5F00', '#4d8cb9', '#0a3452', '#17a2b8'],
    series: [{
      type: 'wordcloud',
      data: wordCloudData,
      name: 'Occurrences'
