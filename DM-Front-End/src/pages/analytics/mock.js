export default {
  ...
  table: [
    {
      id: 0,
      name: 'Lotus of Palm Beach',
      email: 'sales@lotusofpalmbeach.com',
      url: 'https://lotusofpalmbeach.com/',
      server: 'AWS-1',
      status: 'ONLINE',
    },
    {
      id: 1,
      name: 'Alfa Romeo Chicagoland',
      email: 'sales@alfaromeochicagodealers.com',
      url: 'https://alfaromeochicagodealers.com/',
      server: 'AWS-1',
      status: 'ONLINE',
    },
    {
      id: 2,
      name: 'Alfa Romeo Ohio / Kentucky',
      email: 'sales@alfaromeoohiodealers.com',
      url: 'https://alfaromeoohiodealers.com/',
      server: 'AWS-1',
      status: 'ONLINE',
    },
    {
      id: 3,
      name: 'Crosspointe Autoplex',
      email: 'sales@crosspointeautoplex.com',
      url: 'https://crosspointeautoplex.com/',
      server: 'GCP-1',
      status: 'OFFLINE',
    },
  ],
